...
if($text == '/help'){
              ...
              'caption'=>'طرق السحبب',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝐓𝐞𝐥𝐞", 'url'=>"https://t.me/eeeeeb"]],
                       ]
                       ])
                       ]);
            ...
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"لا تقلق ايفور موجود لمساعده 🤍
@eeeeeb",
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                       'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @eeeeeb",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>' 👩‍🔧┇ 𝙰𝙳𝙳 𝙵𝙰𝙺𝙴 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 ','callback_data'=>'login']],
...
لشراء نسخه مراسلة المطور ',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/eeeeeb']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/FF55Q"]],
                  ]
							])
					]);
				}
          ...
          if($data == 'login'){
            ...
            exec('screen -dmS gr php explore.php');
          	...
          	$bot->editMessageText([
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                       'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @S_6_Y",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>' 👩‍🔧┇ 𝙰𝙳𝙳 𝙵𝙰𝙺𝙴 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 ','callback_data'=>'login']],
                          [['text'=>'🦯┇ 𝙶𝙴𝚃𝙸𝙽𝙶 𝚄𝚂𝙴𝚁𝚂','callback_data'=>'grabber']],
              ...
              $keyboard = ['inline_keyboard'=>[
		              ...
		              $bot->editMessageText([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                    'text'=>" 𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙰𝙲𝙲𝙾𝚄𝙽𝚃𝚂 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙿𝙰𝙶𝙴 𝙱𝚈 @eeeeeb 𖤐",
		                  'reply_markup'=>json_encode($keyboard)
		              ]);
